...
#        self.buttons_measure[2].style.font_weight = 'bold'
        ...
        self.drop_window = Dropdown(options=['None', 'hanning'],value='hanning',description='Window:', layout=Layout(width='95%'))
...
class InteractiveView():
    def __init__(self):
        ...
        self.buttons_load[0].button_style ='success'

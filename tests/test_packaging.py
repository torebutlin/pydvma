...
_PUBLIC_SURFACE = [
    ...
    'log_data', 'output_signal', 'signal_generator', 'multisine_generator',
    'stream_snapshot',
    ...
    'create_test_bla_captures',
    'calculate_fft', 'calculate_cross_spectrum_matrix',
    'calculate_cross_spectra_averaged', 'clean_impulse', 'calculate_tf',
    'calculate_tf_averaged', 'calculate_bla', 'multiply_by_power_of_iw',
    'best_match', 'calculate_sonogram', 'calculate_damping_from_sono',
    'calculate_cwt',
